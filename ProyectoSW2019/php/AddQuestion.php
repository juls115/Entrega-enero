        ...
        */
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          if (!empty($_POST["imagen"])) {
            $values[""] = clean_form_data($_POST[""]);
          } else {
            $required[] = "no se ha proporcionado";
          }*/
          ...
          if (empty($required)){
            ...
            $sql_query = "INSERT INTO preguntas(Correo, Pregunta, Respuesta_correcta, R_Erronea_1, R_Erronea_2, R_Erronea_3, Complejidad, Tema)
            VALUES ('" .
            $values["email"] . "','" .
            $values["pregunta"] . "','" .
            $values["respuesta_correcta"] . "','" .
            $values["r_erronea_1"] . "','" .
            $values["r_erronea_2"] . "','" .
            $values["r_erronea_3"] . "','" .
            $values["complejidad"] . "','" .
            ...
            if (mysqli_query($conn, $sql_query)) {
              ...
              echo "<a href='ShowQuestions.php'>Visualizar todas las preguntas</a>";
            } else {
